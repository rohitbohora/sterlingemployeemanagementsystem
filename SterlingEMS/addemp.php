...
<head>
    ...
    <title>Add Employee | Admin Panel | Sterling Employee Management System</title>

    <!-- Include CSS libraries and fonts -->
            ...
            <div class="card card-1">
                ...
                <div class="card-body">
                    ...
                    <form action="process/addempprocess.php" method="POST" enctype="multipart/form-data">
                        <!-- Start of the employee registration form -->
                        ...
                        <!-- Birthday and gender input fields -->
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
